    ...
    <div className="min-h-screen pt-20 h-screen w-full hero-bg">
      ...
      <div className="flex justify-center items-center mt-20 mx-3">
        <div className="w-full max-w-screen-xl p-8 space-y-6 bg-black/60 rounded-lg shadow-md mx-auto">
          <h1 className="text-center text-white text-2xl font-bold mb-4">Sign Up For Publisher</h1>
          ...
          <form className="space-y-4">
            ...
            <button
              ...
              ${loading ? "bg-[#D1007F] cursor-not-allowed" : "bg-[#FF009F] hover:bg-[#D1007F]"}`}
              disabled={loading}
            >
              {loading ? <Spin size="default" style={{ color: "white" }} /> : "Sign Up"}
            </button>
          </form>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg w-11/12 md:w-1/3 max-h-[80vh] flex flex-col">
            <h2 className="text-2xl font-bold mb-4 text-[#FF009F]">Terms and Conditions - Eigakan</h2>
            <div
              className="flex-grow overflow-y-auto mb-4 pr-2"
              style={{ scrollbarWidth: "thin", scrollbarColor: "#FF009F #f0f0f0" }}
            >
              <div className="text-gray-700 space-y-2">
                <p>1. By uploading files, you confirm that you own or have the right to use them.</p>
                <p>
                  2. You are responsible for the content of the uploaded files and must ensure they do not violate
                  copyright or intellectual property rights.
                </p>
                <p>3. Uploaded files must not contain illegal, harmful, or offensive content.</p>
                <p>4. We are not responsible for any content uploaded by users.</p>
                <p>5. If any violation is detected, we reserve the right to remove the files without prior notice.</p>
                <p>6. You agree that uploaded files may be scanned for violations or harmful content.</p>
                <p>7. Uploaded data may be stored and processed for security and compliance purposes.</p>
                <p>8. We do not guarantee the availability or backup of uploaded files.</p>
                <p>9. Sharing or distributing files that violate our policies may result in account suspension.</p>
                <p>10. By using this service, you agree to comply with these terms and all applicable laws.</p>
              </div>
            </div>
            ...
            <div className="flex justify-between mt-4">
              ...
              <button
                ...
                className={`py-2 px-4 ${
                  hasAgreed ? "bg-[#FF009F] hover:bg-[#D1007F]" : "bg-gray-400 cursor-not-allowed"
