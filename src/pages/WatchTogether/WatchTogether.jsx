...
import { Mic, MicOff, Video, VideoOff, Users, MessageSquare, X, SkipForward, RefreshCw } from "lucide-react"
        ...
        renderItem={(participant) => (
          <List.Item className="border-b border-gray-700 py-3">
            <div className="flex items-center w-full">
              <Avatar src={participant.avatar || "/placeholder.svg?height=40&width=40"} size={40} className="mr-3" />
    ...
    return (
      <div className="w-full h-full relative">
        <video
          ...
          ref={(ref) => {
            if (ref && participantStream) {
              ref.srcObject = participantStream
            }
          }}
        />
        ...
        <div className="flex-1 flex flex-col relative">
          ...
          <div className="flex-1 relative bg-black">
            ...
            <div className="absolute bottom-4 right-4 flex flex-wrap gap-2 z-10 max-w-[40%]">
              {roomUsers
                .filter((participant) => participant.id !== user?.id && participant.userName !== user?.fullName)
                .map((participant) => (
                  <div key={participant.id} className="w-32 h-24 bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gray-800">
                        <div className="flex flex-col items-center">
                          <Avatar
                            ...
                            className="mb-1"
                          />
                          <span className="text-white text-xs truncate max-w-[80px]">{participant.userName}</span>
                          <div className="flex items-center gap-1 mt-1">
                            {participant.isMuted && <MicOff size={10} className="text-red-500" />}
                            {participant.isVideoOff && <VideoOff size={10} className="text-red-500" />}
                          </div>
                        </div>
                      </div>
                    )}
          ...
          <div className="bg-gray-900 p-4 border-t border-gray-800">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={handleSeek10Minutes} className="p-2 bg-blue-500 text-white">
                  ⏩ Skip 10 minustes
                </button>
                </Tooltip>
        ...
        {(showChat || showParticipants) && (
          <div className="w-80 bg-gray-900 border-l border-gray-700 flex flex-col">
            ...
            <div className="py-3 px-4 border-b border-gray-700 flex items-center justify-between bg-gray-800">
              <h3 className="text-lg font-medium text-white">{showChat ? "Chat" : "Participants"}</h3>
              <Button
                type="text"
              ...
              {showChat ? (
                ...
                <div className="p-4">
                  <div className="mb-4 text-white">
                    <h3 className="text-lg font-medium mb-2">Participants ({roomUsers.length})</h3>
                  </div>
