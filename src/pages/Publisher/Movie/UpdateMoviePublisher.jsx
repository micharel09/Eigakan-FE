...
const UpdateMoviePublisher = () => {
  ...
  // Add this useEffect for calculating estimated time remaining for video uploads
  useEffect(() => {
  ...
  // Add this function for formatting time remaining
  ...
  const fetchMovieDetails = async () => {
    ...
    try {
      ...
      // Update usedMediaTypes based on existing media
      const newUsedTypes = {
        POSTER: false,
        BANNER: false,
        TRAILER: false,
  ...
  const uploadAllMedia = async () => {
    const mediaToUpload = medias.filter((media) => media.name && media.localFile && media.type)
    ...
    try {
      ...
      const existingMedia = medias.filter((media) => media.url && !media.localFile)
  ...
  // Add this function for handling video uploads to Bunny CDN
  ...
  // Modify the handleUpload function to handle video uploads
          ...
          <TabPane tab="Persons" key="3">
            <Card className="p-4 shadow-md">
              ...
              <Form.Item name="persons" label="Update Cast">
                <Select mode="multiple" placeholder="Select actors" optionLabelProp="label"  onSearch={(value) => setSearchText(value)}
                    ...
                    <div className="p-4">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <Button
                                ...
                                disabled={!media.type}
                              >
                                {media.previewUrl ? "Change Media" : "Select Media"}
                              </Button>
                            </Upload>
                          </div>
                          ...
                          {uploadingMedia && currentUploadingIndex === index && (
                            <div className="mt-4">
                              <div className="flex items-center">
                          ...
                          {media.localFile && !uploadingMedia && currentUploadingIndex !== index && (
                            <Alert
            ...
            <Card className="p-4 shadow-md">
              <div className="space-y-8">
                ...
                <div className="bg-blue-50 p-5 rounded-lg border border-blue-200">
                  ...
                  <Form.Item name="isContract" valuePropName="checked" className="mb-0">
                ...
                <div>
                  ...
                  {fileUrl && (
                    <div className="mb-6 p-4 border rounded-md bg-blue-50">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-medium text-blue-700">Current Verification File</p>
                          <span
                  ...
                  <div className="mt-4">
                    <h4 className="text-md font-medium text-gray-700 mb-2">Update Verification File</h4>
                    <Dragger
                      name="file"
                      multiple={false}
                      beforeUpload={() => false}
                    ...
                    >
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 text-sm mt-1">Upload a new file to verify your movie ownership</p>
                      </div>
                    </Dragger>
                  </div>
