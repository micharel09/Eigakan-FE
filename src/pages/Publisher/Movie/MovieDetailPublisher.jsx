                ...
                <div className="flex flex-col gap-4 w-full">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      ...
                      {!getMediaUrl("TRAILER") && !getMediaUrl("FILMVIP") && movie.status === "WAITING_FOR_UPLOADING" && (
                       <Link
          ...
          <Form layout="vertical">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Form.Item label="Origin Name">
                <Input
                  ...
                  onChange={(e) => setEditMovie((prev) => ({ ...prev, originName: e.target.value }))}
                />
              </Form.Item>
              ...
              <Form.Item label="Release Year">
                <Input
                  ...
                  onChange={(e) => setEditMovie((prev) => ({ ...prev, releaseYear: e.target.value }))}
                />
              </Form.Item>
              ...
              <Form.Item label="Duration">
                <Input
                  ...
                  onChange={(e) => setEditMovie((prev) => ({ ...prev, duration: e.target.value }))}
                />
              </Form.Item>
              ...
              <Form.Item label="Director">
                <Input
                  ...
                  onChange={(e) => setEditMovie((prev) => ({ ...prev, director: e.target.value }))}
                />
              </Form.Item>
              ...
              <Form.Item label="Nation">
                <Input
                  ...
                  onChange={(e) => setEditMovie((prev) => ({ ...prev, nation: e.target.value }))}
                />
              </Form.Item>
            </div>
            ...
            <Form.Item label="Description">
              <Input.TextArea
                ...
                onChange={(e) => setEditMovie((prev) => ({ ...prev, description: e.target.value }))}
                rows={4}
              />
            </Form.Item>
